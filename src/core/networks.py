...
class SiameseNet:
    def __init__(self, inputs, arch, siam_reg, y_true, model_path):
        ...
        self.distance = Lambda(costs.euclidean_distance, output_shape=costs.eucl_dist_output_shape)(
    ...
    def train(self, pairs_train, dist_train, pairs_val, dist_val,
        ...
        hist = self.net.fit_generator(train_gen_, epochs=num_epochs, validation_data=validation_data,
                                      steps_per_epoch=steps_per_epoch, callbacks=[self.lh])
